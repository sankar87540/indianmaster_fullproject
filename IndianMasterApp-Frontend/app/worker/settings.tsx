...
import { User, Phone, Briefcase, Star, Lock, ChevronRight } from 'lucide-react-native';
...
export default function WorkerSettingsScreen() {
    ...
    const handleSave = async () => {
        ...
        setApiError('');
        try {
            // Update user record (fullName lives in the users table)
            ...
            setApiError(e?.message ?? 'Failed to update settings. Please try again.');
        } finally {
